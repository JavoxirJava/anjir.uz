...
const NAV_ITEMS = [
  ...
  { href: "/teacher/parents",      label: "Ota-onalar",                 icon: "👨‍👩‍👧" },
      ...
      <header style={{ background: "#0f766e" }} className="sticky top-8 z-40" role="banner">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex h-13 items-center gap-3">
            ...
            {/* Logo */}
            <Link href="/teacher" className="flex items-center gap-2 flex-shrink-0 focus-visible:outline-2 focus-visible:outline-white" aria-label="I-Imkon.uz">
